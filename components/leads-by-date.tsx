...
import { getLeadsByFollowUpDate } from "@/lib/filter-fn/followups-by-date";

const ITEMS_PER_PAGE = 3;

export default function LeadListByFollowupDate({
    leads: initialLeads,
}: {
    leads: Lead[];
}) {
    ...
    const followupDate = searchParams.get("date") as string | undefined;

    const result = useMemo(() => {
        return getLeadsByFollowUpDate(
            initialLeads,
            followupDate,
            page,
            ITEMS_PER_PAGE
